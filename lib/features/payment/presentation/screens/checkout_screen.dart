...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    super.initState();
    _selected = MockData.eventById(widget.eventId).tickets.first;
  }
  ...
  int get _total => _selected.priceXof * _quantity;
  ...
  Widget build(BuildContext context) {
    final event = MockData.eventById(widget.eventId);
              ...
              child: AppSurfaceCard(
                ...
                child: Row(
                  children: [
                    ...
                    PriceText(amountXof: t.priceXof),
                  ],
                ),
              ),
            );
          ...
          AppSurfaceCard(
            child: Row(
              ...
              children: [
                ...
                PriceText(amountXof: _total, fontSize: 16),
              ],
            ),
          ),
