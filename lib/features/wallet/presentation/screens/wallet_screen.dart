              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${PriceText.formatXof(MockData.walletBalance)} F',
                      style: GoogleFonts.inter(
                        fontSize: 28,
                    ...
                    Text(
                      'En attente : ${PriceText.formatXof(MockData.walletPending)} F',
                      style: GoogleFonts.inter(
                        fontSize: 12,
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(
                        ...
                        size: 18,
                        color: tx.isCredit ? AppColors.green : AppColors.navy,
                      ),
                    ),
                    ...
                    Text(
                      '${tx.isCredit ? '+' : '-'} ${PriceText.formatXof(tx.amountXof)} F',
                      style: GoogleFonts.inter(
                        fontSize: 13,
                        fontWeight: FontWeight.w600,
                        color:
                            tx.isCredit ? AppColors.green : AppColors.orange,
                      ),
                    ),
                  ],
                ),
